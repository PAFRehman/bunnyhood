...
if (!/YOUR REFERRAL CODE/.test(waitlistApp) || !/TOP 50/.test(waitlistApp) || !/limit 50/.test(waitlistData)) failures.push("Waitlist referral recovery or Top 50 GTD leaderboard messaging is incomplete.");
